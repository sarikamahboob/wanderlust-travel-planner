...
Respond ONLY with the JSON object, no additional text.`;
    ...
    if (!parsedResponse.title || !parsedResponse.description || !parsedResponse.highlights || !parsedResponse.itinerary) {
      throw new Error('AI response missing required fields (title, description, highlights, or itinerary)');
    }
